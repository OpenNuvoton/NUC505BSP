...
/**
  * @brief      Erase the sector where the specified address is located.
  * @note       Sector size is 4KB.
  * @note       Support by most SPI Flash devices.
  */
...
/**
  * @brief      Erase the sector where the specified address range is located.
  * @note       Sector size is 4KB.
  * @note       Support by most SPI Flash devices.
  */
