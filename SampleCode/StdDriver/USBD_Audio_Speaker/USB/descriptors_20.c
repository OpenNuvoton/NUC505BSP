...
/*
  *Speaker - Interface alternate 1~2
  ...
  1.If you want to remove certain alternate for Speaker interface, please remove the group of 
    ...
    For example,
      Remove  Speaker Interface alternate 2 (24 bit resolution) from Speaker descriptor with HID 
		
      1.Remove the following descriptors for Speaker - Interface alternate 2
         Speaker - Interface alternate 2
           ...
           AS Isochronous Feedback Endpoint Descriptor                  (0x07)											 
           *Interface alternate Summary                                 (0x35) 														 
					 
      2.Modify the Total Length field of Configuration Descriptor to 0xB1.
         
         0xE6(Original Total Length) - 0x35(Total Length of descriptors for Speaker - Interface alternate 2) = 0xB1. 
...
#else
__align(4) uint8_t gu8KeyboardReportDesc_20[] =
#endif
{
...
__align(4) uint8_t gu8ConfigDescriptor[] = {
    ...
    0x01,                                   /* bSourceID */
    0x03, 0x00, 0x00, 0x00,                 /* bmaControls(0)
                                               Master control
                                                D1..0: Mute Control
                                                D3..2: Volume Control
                                                D5..4: Bass Control
