...
#define OPCODE_RDRP             0x61    /* ISSI: Read Read parameters (volatile) */
#define OPCODE_SRPNV            0x65    /* ISSI: Set Read parameters (non-volatile) */
#define OPCODE_SRPV             0xC0    /* ISSI: Set Read parameters (volatile) */
